...
export const TutorialCard = ({ tutorial }: TutorialCardProps) => {
  return (
    <Link
      ...
      data-tutorial-card
      className="group block overflow-hidden rounded-3xl border border-slate-200/80 bg-white shadow-sm shadow-slate-900/5 transition duration-300 hover:-translate-y-1 hover:shadow-[0_22px_58px_rgba(15,23,42,0.1)] focus:outline-none focus:ring-4 focus:ring-[#FF6B81]/22"
    >
      <article>
